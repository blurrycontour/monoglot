package io.blurrycontour.monoglot
...
import io.blurrycontour.monoglot.ui.screens.SettingsScreen
import io.blurrycontour.monoglot.ui.screens.SystemScreen
import io.blurrycontour.monoglot.ui.screens.WordsScreen
import io.blurrycontour.monoglot.ui.theme.MonoglotTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun rescheduleReminders() {
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.Default).launch {
            val store = io.blurrycontour.monoglot.reminders.ReminderStore(ctx)
            io.blurrycontour.monoglot.reminders.ReminderScheduler.rescheduleAll(ctx, store.all())
        }
    }
